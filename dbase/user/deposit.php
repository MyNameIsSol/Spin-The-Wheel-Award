                ...
                <div class="page-breadcrumb"  style="background-color: #fff !important; padding: 20px 20px 0;">
                    <div class="row">
                      <div class=" col-lg-12 col-md-12 col-xs-12 p-0" style="margin-bottom: 10px;">
                        <h3 class="card-title" style="font-size: 1.80rem; margin-bottom: 3px; font-weight: 700;">Deposit</h3>
                  ...
                  <div class="" style="margin: 20px 0 30px; padding: 20px 20px; align-items: center; border: 1px solid rgb(226, 224, 224); border-radius: 3px;">
                    <h1 style="font-size: 2rem;font-family: Nunito, sans-serif;color: #364a63;font-weight: 700;letter-spacing: -0.03em;">You are about to deposit <?= isset($currency) ? $currency : "$" ?> <?= isset($fundamount) ? $fundamount : "" ?></h1>
                           <div class="ref-form mt-4">
                            <form method="post" action="fundaccount.php" id="fundform" name="depos" onsubmit="return CheckValid()">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                      <input type="number" value="<?= isset($fundamount) ? $fundamount : "" ?>" class="form-control" id="deposit" name="fundamount" />
                                      <label for="tb-email">Enter deposit amount</label>
                                  ...
                                  <div class="col-12 ">
                                    <div class="ms-auto mt-4">
                                      <div class="spinbut" style="margin-top: 10px;">
                                          <button id="spinbut" type="submit" name="fundpay" style="outline: none; border: 1px solid black; padding: 6px 15px; border-radius: 5px;"> 
                                            <small style="font-size: 15px; font-weight: 700; margin-left: 2px;">Recharge</small> </button>
                                        </div>
                                    </div>
                                </div>
                            </form>
